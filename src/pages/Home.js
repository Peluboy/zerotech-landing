    ...
    <div className="Home">
            ...
            <div className="sessions">
              <div className="first">
                ...
                <div className="bottom">
                  <Link to="/crm-erp-ecm-fullstack-etlsolution">
                    <div className="div-5">
                      <img
                        src="./assests/CRM-1.svg"
                        style={{ width: 40, left: 20, top: 25 }}
                        alt=""
                      />
                      <h3>CRM / ERP / ECM / Full Stack / ETL Solutions</h3>
                      <img
                        src="./assests/CRM-2.svg"
                        style={{ width: 70, right: 10, bottom: 0 }}
                        alt=""
                      />
                    </div>
                  </Link>
              ...
              <div className="third">
                <Link to="/ui-ux-design">
                  <div className="div-4">
                    <img
                      src="./assests/UI-1.svg"
                      style={{ width: 40, right: 20, top: 20 }}
                      alt=""
                    />
                    <h3>UI/UX Design</h3>
                    <img
                      src="./assests/UI-2.svg"
                      style={{ width: 80, bottom: 15 }}
                      alt=""
                    />
                  </div>
                </Link>
      ...
      <div className="rightSection">
        <div className="rightContainer">
          <div className="arrow">
            <img
              src="./assests/arrow-1.svg"
              style={{ width: 30, right: 20, top: 20 }}
              alt=""
            />
          </div>
          <div className="title">
